...
const Rooms = () => {
    ...
    const columns = [
        { sortable: true, width: '50%', key: "fullName", label: "Аудитория", type: "text" },
        { sortable: true, width: '50%', key: "floor", label: "Этаж", type: "text" },
    ];

    return (
        <>
            <PageHeader onAdd={() => handleOpenModal()} title={'Аудитории'} />
